...
const projects = [
  {
    ...
    description: 'Dashboard completo para gestão de loja virtual com analytics em tempo real, gestão de produtos e integração com múltiplos gateways de pagamento.',
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <Button
            variant="outline"
            size="lg"
            className="rounded-full border-zinc-300 hover:border-zinc-400 group"
          >
